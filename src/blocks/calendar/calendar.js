	...
	(function () {
		...
		var Datepicker = function (el, options) {
			...
			if (this.opts.altField) {
				this.$altField =
					typeof this.opts.altField == "string" ? $(this.opts.altField) : this.opts.altField;
			}
  ...
  //class changed
	(function () {
		var template =
			...
			button = '<span class="datepicker--button #{action}" data-action="#{action}" >#{label}</span>',
			datepicker = $.fn.datepicker,
			dp = datepicker.Constructor;
	...
	(function () {
		...
		datepicker.Timepicker.prototype = {
			...
			_setDefaultMinMaxTime: function () {
				...
				this.maxMinutes =
					opts.maxMinutes < 0 || opts.maxMinutes > maxMinutes ? maxMinutes : opts.maxMinutes;
			},
